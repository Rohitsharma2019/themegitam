...
$supporturl = theme_gitam_get_setting('supporturl');
...
$url = ($supporturl != '' || $iosappurl != '' || $androidappurl != '' || $fburl != '' || $pinurl != '' || $twurl != '' || $gpurl != '') ? 1 : 0;
...
echo $OUTPUT->render_from_template('theme_gitam/footer', $templatecontext);